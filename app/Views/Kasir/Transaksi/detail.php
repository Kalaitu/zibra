                ...
                <div class="card shadow">
                    ...
                    <div class="p-4">
                        ...
                        <div class="row mt-5">
                            ...
                            <form action="<?= base_url('kasir/konfirmasi') ?>" method="post">
                                <div class="col-12">
                                    <input type="text" name="kode_pemesanan" value="<?= $datatransaksi[0]->kode_pemesanan ?>" hidden>
                                    <button class="btn btn-primary w-100 <?= $datatransaksi[0]->status == 'Selesai' ? 'd-none' : '' ?>">Konfirmasi</button>
                                </div>
                            </form>
                        </div>
                    </div>
