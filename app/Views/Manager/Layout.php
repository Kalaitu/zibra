...
<body class="hidescroll">
  <?php if (session()->get('statusmanager') != true) : ?>
    <script>
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          <li class="menu-item <?= $aktif1 ?>">
            <a href="<?= base_url('manager') ?>" class="menu-link">
              <i class="menu-icon tf-icons bx bx-home-circle"></i>
              <div data-i18n="Analytics">Dashboard</div>
            </a>
          </li>
          <li class="menu-item <?= $aktif2 ?>">
            <a href="<?= base_url('manager/karyawan') ?>" class="menu-link">
              <i class="menu-icon tf-icons bx bx-support"></i>
              <div data-i18n="Analytics">Karyawan</div>
            </a>
          </li>
          <li class="menu-item <?= $aktif3 ?>">
            <a href="<?= base_url('manager/customer') ?>" class="menu-link">
              <i class="menu-icon tf-icons bx bx-user-circle"></i>
              <div data-i18n="Analytics">Customer</div>
            </a>
          </li>
          <li class="menu-item <?= $aktif4 ?>">
            <a href="<?= base_url('manager/produk') ?>" class="menu-link">
              <i class="menu-icon tf-icons bx bx-cube-alt"></i>
              <div data-i18n="Analytics">Produk</div>
            </a>
          </li>
          <li class="menu-item <?= $aktif5 ?>">
            <a href="<?= base_url('manager/transaksi') ?>" class="menu-link">
