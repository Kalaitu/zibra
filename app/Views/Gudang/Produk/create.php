                    ...
                    <div class="row g-0">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="row">
                                    <div class="col-md-3">
                                        <img class="card-img card-img-left" id="output" src="<?= base_url('produk/dummyfoto.jpg') ?>" alt="Card image">
                                    </div>
                                    <div class="col-md-9">
                                        <form method="post" action="<?= base_url('gudang/produk/add') ?>" enctype="multipart/form-data">
                                            <div class="card-body">
                                                <div class="w-100">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 col-sm-12 mb-3">
                                                        <input type="number" class="form-control" id="hargaproduk" name="hargaproduk" placeholder="Harga Produk (Rp.0,-)" required>
                                                    </div>
                                                    <div class="col-md-4 col-sm-12 mb-3">
                                                    ...
                                                    <div class="col-md-8 col-sm-12">
                                                        <textarea class="form-control" id="deskripsiproduk" name="deskripsiproduk" rows="3" placeholder="Masuan Deskripsi Produk" required></textarea>
                                                    </div>
